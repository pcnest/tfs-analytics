...
const MAX_REPORT_SCOPE_FEATURE_REMARKS = 200;
...
const WEEKLY_REPORT_FEATURE_REMARK_FIELDS = [
  'featureId',
...
function getSyncRequestPolicy(body = {}, options = {}) {
  ...
  if (
    ...
    Object.prototype.hasOwnProperty.call(body, 'featureRemarks')
  ) {
    return {
      ok: false,
      status: 400,
      error: 'featureRemarks are supported only for report-scope-refresh',
    };
  }
  ...
  return {
    ...
    reportScopeRefresh: {
      ...
      weeklyReportRemarks: {
        ...
        referencedFeatures: {
          supported: true,
          maxRows: MAX_REPORT_SCOPE_FEATURE_REMARKS,
          fields: WEEKLY_REPORT_FEATURE_REMARK_FIELDS,
        },
      },
    },
  };
