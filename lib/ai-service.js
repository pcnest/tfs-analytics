...
- In the Confidence column, show the percent AND a trend arrow indicator only (no numeric delta). Use green (#0a7c2f) ▲ for "up", red (#b42318) ▼ for "down". For flat/unknown, show a gray ( #4b5563 ) "—" or omit the arrow.
